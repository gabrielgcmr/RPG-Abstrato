...
const ataque_1 = require("./ataque");
const TesteIniciativa_1 = require("./TesteIniciativa");
//=====================================================================================================//
//////////////////////////////////////////////FUNÇÃO DE DUELO!/////////////////////////////////////////
//=====================================================================================================//
function Turno(...Lutadores) {
    var Ordem = (0, TesteIniciativa_1.OrdemDeAtaque)(...Lutadores);
    ...
    while (OrdemDeHerois.length > 0 || OrdemDeMonstros.length > 0) {
        ...
        if (Ordem[iOrd].tipo == 'Personagem') {
            ...
            (0, ataque_1.Ataque)(OrdemDeHerois[iHer1], OrdemDeMonstros[iMonst1]); //realizando ataque//=======================
            console.log('------------------------------------------------------------');
            //------------------------------------------------------------------------------------------------------------------------
            ...
            (0, ataque_1.Ataque)(OrdemDeMonstros[iMonst], OrdemDeHerois[iHer]); //Se for um Monstro 
